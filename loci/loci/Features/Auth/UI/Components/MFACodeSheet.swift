        ...
        NavigationStack {
            VStack(spacing: 24) {
                VStack(spacing: 8) {
                    ...
                    Text("Enter the verification code from your authenticator app to complete sign in.")
                        .font(.subheadline)
                ...
                Button {
                    ...
                    Text(useRecoveryCode ? "Use Authenticator Code instead" : "Use a backup recovery code")
