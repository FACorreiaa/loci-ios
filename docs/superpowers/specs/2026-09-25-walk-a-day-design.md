...
3. **Arrival** (within 25 m). The phone gives a success haptic, and a local notification "You're at X (3 of 6)" is posted if the app is not active. The line clears. The card reads "You're at X (3 of 6)" and offers **Walk to next: Y · 8 min**, which is a preview route fetched on arrival, plus **Skip**. The step count keeps running.
